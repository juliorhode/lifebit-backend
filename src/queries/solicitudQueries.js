...
const OBTENER_SOLICITD_POR_ID = `select id,nombre_solicitante,apellido_solicitante,email_solicitante,telefono_solicitante,cedula_solicitante,nombre_edificio,direccion_edificio,id_licencia_solicitada,estado,fecha_solicitud from solicitudes_servicio where id = $1 and estado = 'pendiente'`;
