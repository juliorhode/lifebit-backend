...
module.exports = {
    ...
    // Añadimos logging de las queries en desarrollo para depuración.
    // En producción, esto no se ejecuta para evitar llenar los logs.
	query: async (text, params) => {
		if (process.env.NODE_ENV !== 'production') console.log('🧩 SQL:', text);
